...
import { Briefcase, ArrowLeft, Mail, Lock, User, Eye, EyeOff, Loader2 } from 'lucide-react';
...
const VendorSignup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        // Success! Redirect to vendor KYC page
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 pt-24 pb-16 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="vendorPattern" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#vendorPattern)"/>
        </svg>
      </div>
      ...
      <div className="max-w-md mx-auto relative z-10">
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 via-amber-500 to-yellow-500 shadow-lg mb-4">
            ...
            <p className="text-gray-600">
              Start offering your services to event organizers across Africa
            </p>
          </div>
